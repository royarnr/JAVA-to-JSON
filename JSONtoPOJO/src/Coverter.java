...
public class Coverter {
	...
	public static void main(String[] args) {
		...
		/*
		 *Initialize parameters for the Address object 
		 *embedded in Person object
		 */
		Address address = new Address();
		address.setBuildingno("B-2");
		address.setStreet1("Narkelbagan");
		address.setStreet2("Garia");
		address.setCity("Kolkata");
		address.setPostalcode("700084");
		address.setProvince("West Bengal");
